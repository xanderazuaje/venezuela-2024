...
return (
    <svg width="51" height="51" viewBox="0 0 V51 51" fill="none" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer" onClick={onClick}>
        <g clip-path="url(#clip0_104_96)">
            ...
            <path d="M19.125 25.5L23.375 29.75L31.875 21.25" stroke="white" stroke-width="2.75"
